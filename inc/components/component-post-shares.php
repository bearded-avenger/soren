...
if (!function_exists('soren_post_shares')):
	...
	function soren_post_shares($togglecomment = false){
		...
		$out = true == $togglecomment ? sprintf('<section class="soren-post-shares">%s%s%s</section>',$twitter, $facebook, $togglecomment) : sprintf('<section class="soren-post-shares">%s%s</section>',$twitter, $facebook);
