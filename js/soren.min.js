jQuery(document).ready(function(){jQuery("body").css("display","none");jQuery("body").fadeIn(500);jQuery(".pushy a, .soren-fader").click(function(b){b.preventDefault();newLocation=this.href;jQuery("body").fadeOut(400,a)});function a(){window.location=newLocation}});(function(a){a.fn.parallax=function(b){var d=a(window).height();var c=a.extend({speed:0.15},b);return this.each(function(){var e=a(this);a(document).scroll(function(){var h=a(window).scrollTop();var i=e.offset().top;var f=e.outerHeight();if(i+f<=h||i>=h+d){return}var g=Math.round((i-h)*c.speed);e.css("background-position","center "+g+"px")})})}}(jQuery));
